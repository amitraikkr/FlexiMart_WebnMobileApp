                ...
                <div class="card-bodys">
                    ...
                    <div class="row mb-4 p-16">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mt-3">
                            <div class="cards add-new-role-card border-0 h-100">
                                <div class="row">
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="card-body text-sm-end text-center ps-sm-0 ms-2">
                                            <a href="{{ route('admin.roles.create') }}">
                                                <span class="btn add-role-btn fw-bold text-uppercase btn-sm mb-1">{{ __("Add New Role") }}</span>
                                            </a>
                        ...
                        @foreach($roles as $role)
                            <div class="col-xl-4 col-lg-6 col-md-6 mt-3">
                                <div class="cards  border-0">
                                    <div class="card-body card-body-role">
                                        <div class="d-flex justify-content-between">
                                            <span>{{ __("Total :count users", ['count' => $role->users_count]) }}</span>
                                            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                                                @foreach($role->users->take(5) as $user)
                                                    <li class="avatar avatar-sm pull-up">
                                                        <img class="rounded-circle" src="{{ asset($user->image ?? 'assets/images/icons/default-user.png') }}" alt="{{ ucfirst($user->name) }}">
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                                            <div class="role-heading">
                                                ...
                                                <a class="primary" href="{{ route('admin.roles.edit', $role->id) }}">
                                                    <small class="fw-bolder d-flex align-items-center gap-1"><i class="far fa-edit"></i><span>{{ __("Edit Role") }}</span></small>
                                                </a>
                                                @endcan
                                            </div>
                                        </div>
