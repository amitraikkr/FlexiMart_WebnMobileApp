            ...
            <div class="card">
                <div class="card-bodys">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="formet-container d-flex align-items-center gap-3">
                            <img src="{{ asset('assets/images/icons/csv.svg') }}" alt="user">
                            <img src="{{ asset('assets/images/icons/excel.svg') }}" alt="user">
                            <img src="{{ asset('assets/images/icons/pdf.svg') }}" alt="user">
                            <img src="{{ asset('assets/images/icons/printer.svg') }}" alt="user">
                        </div>
                    </div>
                </div>

                <div class="responsive-table m-0">
                    <table class="table table-striped bg-striped" id="datatable">
                        <thead>
                            <tr>
