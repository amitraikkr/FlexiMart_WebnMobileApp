            ...
            <div class="card border-0">
                <div class="card-bodys shadow-sm">
                    <div class="table-header p-16">
                        <h4>{{__('Edit Plan')}}</h4>
                        @can('plans-read')
                            <a href="{{ route('admin.plans.index') }}" class="add-order-btn rounded-2 {{ Route::is('admin.users.create') ? 'active' : '' }}"><i class="far fa-list" aria-hidden="true"></i> {{ __('Plan List') }}</a>
                        @endcan
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="col-lg-12 my-2">
                                            <label>{{ __('Live Support') }}</label>
                                            <div class="form-control d-flex justify-content-between align-items-center radio-switcher">
                                                <p class="dynamic-text"></p>
                                                <label class="switch m-0">
                                                    <input type="checkbox" name="live_support" placeholder='Live Support' class="change-text" checked>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="col-lg-12 my-2">
                                            <label>{{ __('6 months technical support') }}</label>
                                            <div class="form-control d-flex justify-content-between align-items-center radio-switcher">
                                                <p class="dynamic-text"></p>
                                                <label class="switch m-0">
                                                    <input type="checkbox" name="technical_support" class="change-text" checked>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="col-lg-12 my-2">
                                            <label>{{ __('Free installation') }}</label>
                                            <div class="form-control d-flex justify-content-between align-items-center radio-switcher">
                                                <p class="dynamic-text"></p>
                                                <label class="switch m-0">
                                                    <input type="checkbox" name="free_installation" class="change-text" checked>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="col-lg-12 my-2">
                                            <label>{{ __('Free installation cPanel') }}</label>
                                            <div class="form-control d-flex justify-content-between align-items-center radio-switcher">
                                                <p class="dynamic-text"></p>
                                                <label class="switch m-0">
                                                    <input type="checkbox" name="installation_cPanel" class="change-text" checked>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
