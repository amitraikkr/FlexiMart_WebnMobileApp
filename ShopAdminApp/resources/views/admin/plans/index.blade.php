        ...
        <div class="card">
            <div class="card-bodys ">
                <div class="table-header p-16">
                    ...
                    @can('plans-create')
                        <a type="button" href="{{route('admin.plans.create')}}" class="add-order-btn rounded-2 {{ Route::is('admin.plans.create') ? 'active' : '' }}" class="btn btn-primary" ><i class="fas fa-plus-circle me-1"></i>{{ __('Add Plan') }}</a>
                    @endcan
                </div>
            ...
            <div class="responsive-table m-0">
                <table class="table bg-striped" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start striped-th">{{ __('Subscription Name') }}</th>
                        <th class='striped-th'>{{ __('Duration') }}</th>
                        <th class='striped-th'>{{ __('Offer Price') }}</th>
                        <th class='striped-th'>{{ __('Subscription Price') }}</th>
