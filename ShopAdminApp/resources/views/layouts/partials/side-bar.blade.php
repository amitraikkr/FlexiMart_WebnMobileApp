<nav class="side-bar">
    ...
    <div class="side-bar-manu">
        <ul>
            ...
            @canany(['product-import-read', 'product-import-create'])
            <li class="{{ Request::routeIs('admin.products.import') ? 'active' : '' }}">
                <a href="{{ route('admin.products.import') }}" class="active">
                    <span class="sidebar-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19.545 5.87097L18.506 2.79897C18.017 1.35497 17.412 0.250977 14.5 0.250977H5.50001C2.58801 0.250977 1.983 1.35497 1.495 2.79897L0.453985 5.87196C-0.00701529 7.23596 0.336005 8.68797 1.25001 9.64397V16C1.25001 18.418 2.58201 19.75 5.00001 19.75H15C17.418 19.75 18.75 18.418 18.75 16V9.64297C19.664 8.68697 20.0061 7.23497 19.545 5.87097Z" fill="currentColor"/>
                        </svg>
                    </span>
                    {{ __('Import Products') }}
                </a>
        ...
        @endcanany
            ...
            @canany(['customer-orders-read', 'pcustomer-orders-delete', 'customer-orders-update'])
                <li class="{{ Request::routeIs('admin.orders.index','admin.orders.show') ? 'active' : '' }}">
                    <a href="{{ route('admin.orders.index') }}" class="active">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 2.5H2.5C1.12 2.5 0 3.62 0 5V15C0 16.38 1.12 17.5 2.5 17.5H17.5C18.88 17.5 20 16.38 20 15V5C20 3.62 18.88 2.5 17.5 2.5ZM2.5 15V5H17.5V15H2.5Z M15 7.5H5V8.75H15V7.5Z M15 10H5V11.25H15V10Z M10 12.5H5V13.75H10V12.5Z" fill="currentColor"/>
                            </svg>
                        </span>
                        {{ __('Customer Orders') }}
                    </a>
