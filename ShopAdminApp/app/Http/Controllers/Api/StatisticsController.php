...
class StatisticsController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $data = [
            ...
            'total_expense' => (float) $expense_amount + $purchase_amount,
            'total_items' => Product::where('business_id', $business_id)->whereBetween('created_at', [$start, $end])->count(),
            'total_categories' => Category::where('business_id', $business_id)->whereBetween('created_at', [$start, $end])->count(),
            ...
            'total_profit' => (float) Sale::where('business_id', $business_id)->whereBetween('created_at', [$start, $end])->sum('lossProfit'),
